...
export const STORIES: Story[] = [
  {
    ...
    available: true,
    patient: PATIENTS[0],
    events: [EVENTS.grapefruit, EVENTS.apfel],
  },
  ...
  { id: 'gene', titleKey: 'story.gene.title', descKey: 'story.gene.desc', icon: '🧬', color: '#b794ff', available: false, patient: PATIENTS[0], events: [] },
  { id: 'ddi', titleKey: 'story.ddi.title', descKey: 'story.ddi.desc', icon: '💊', color: '#4cc9f0', available: false, patient: PATIENTS[0], events: [] },
  { id: 'organ', titleKey: 'story.organ.title', descKey: 'story.organ.desc', icon: '🫘', color: '#ff6b7a', available: false, patient: PATIENTS[0], events: [] },
